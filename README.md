...
วัดผลตอบแทนจริงเทียบกับ S&P500

- **TWR (Time-Weighted Return)** — ผลตอบแทนของการลงทุนล้วนๆ ไม่รวมผลจากจังหวะเติม/ถอนเงิน ใช้เทียบกับดัชนีได้ตรงๆ
- **IRR / MWR** — ผลตอบแทนจริงของเงินคุณ รวมผลจังหวะเข้าออกด้วย
- **กราฟ** — เทียบมูลค่าพอร์ตกับ "ถ้าเอาเงินก้อนเดียวกันไปลง S&P500 แทน" เลือกช่วงเวลาได้ (1M/3M/6M/YTD/1Y/3Y/5Y/All) เอาเมาส์ชี้ดูตัวเลขรายวันได้ กดลิงก์ *"แสดงเป็นตาราง"* ถ้าอยากดูเป็นตัวเลข
- **Historical Return** — ตารางผลตอบแทนแยกรายเดือน/ไตรมาส/ปี ไล่สีเขียว-แดงตามกำไรขาดทุน
